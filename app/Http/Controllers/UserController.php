...
class UserController extends Controller
{
    ...
    public function update(Request $request, User $user)
    {
        ...
        if ($request['password']==NULL){
            $act=User::where('id',$user->id)->update(['email'=>$request->email,'Tipo'=>$request->Tipo,'direccion'=>$request->direccion,'name'=>$request->name,'telefono'=>$request->telefono]);
        }else{

            $act=User::where('id',$user->id)->update(['password'=>Hash::make($request['password']),'email'=>$request->email,'Tipo'=>$request->Tipo,'direccion'=>$request->direccion,'name'=>$request->name,'telefono'=>$request->telefono]);
        }
