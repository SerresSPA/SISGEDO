...
route::get('solicitudes/{id}','SolicitudesController@show')->name('solicitudes.show');//->middleware('permission:solicitudesClienteEnviadas.crud');// formulario de solo muestra de información del rol
...
route::post('/tags/saved','TagsController@update')->name('tags.update')->middleware('permission:admsol.index');//ruta de actualización del registro
