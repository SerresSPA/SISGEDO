                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            @endcan
                            <!--@can('admsol.index')    
                                <a class="dropdown-item" href="{{ route('estructuras.propiedades') }}">Características en el Contrato</a>
                            @endcan -->
                            @can('admsol.index')    
                                <a class="dropdown-item" href="{{ route('cambiarEstado.solicitud') }}">Cambiar Estado de Solicitud</a>
                            @endcan
                            @can('admsol.index')    
                                <a class="dropdown-item" href="{{ route('asigancionsolicitudes.inspector') }}">Asignación de Solicitudes a Inspectores.</a>
                            @endcan
                            <!-- @can('admsol.index')    
