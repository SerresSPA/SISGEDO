                    ...
                    @else
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                ...
                                @endcan 
                                @can('solicitudesCliente.index')
                                    <a class="dropdown-item" href="{{ route('solicitudesClienteGuardadas.index') }}">Solicitudes Aprobadas</a>
                                @endcan  -->
                                <!-- @can('solicitudesClienteEnviadas.crud')
                                    <a class="dropdown-item" href="{{ route('solicitudesClienteDeclaradas.index') }}">Solicitudes con Declaración Jurada</a>
                                @endcan  -->
                                <!-- @can('solicitudesCliente.index')
                                    <a class="dropdown-item" href="{{ route('solicitudesClienteAdmin.index') }}">Totalidad de Solicitudes de Contratistas</a>
                                @endcan  -->
                                ...
                                <a class="dropdown-item" href="{{ route('documentosCliente.index') }}">Documentación</a>
                                <a class="dropdown-item" href="{{ route('homeCliente') }}">Dashboard</a>
