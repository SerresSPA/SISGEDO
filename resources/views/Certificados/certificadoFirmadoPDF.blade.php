...
<img src="spa.png" width="150" height="40">
    <hr>
    <div  class="titulo">
    <label class="letraT">Rut:76.393.817-4 CERTIFICADO DE CUMPLIMIENTO DE OBLIGACIONES LABORALES Y PREVISIONALES N° 
    @if ($cert->estado=="REEMPLAZADO") 
        R-{{$cert->id }} por C-{{ $cert->abreviacion}} 
    @else 
        C-{{$cert->id }} 
        @foreach($insp as $solicitudActual)
            @if ($solicitudActual->certificadoReemplazo!=NULL)
                por R-{{$solicitudActual->certificadoReemplazo }}
            @endif
        @endforeach
    @endif
            ...
            <table>
                <thead>
                    ...
                    <th class="">
                            ...
                            <img src="selloOficialSF.png" width="85" height="85" >
                        </th>
                        <th class="">
                        ...
                        <?php
                            ...
                            $doc='http://clientes.serreschile.cl/Archivos/'.$cert->anio.'/CERT-'.$cert->id.'-'.$mesLetra.'-'.$cert->anio.'-Solicitud-'.$cert->solicitud_id.'.pdf';
                            //dd($doc);
                        ?>
                        @php
    ...
    <strong><label class="letraE">1.- Observación parte Remuneracional</label></strong>
    <table>
        <thead>
            <tr>
...
<div class="row">
    ...
    <div class="divx3 allado divI textM2">
        <img src="selloOficialSF.png" width="112" height="97" >
    </div>    
</div>   
<!-- fin tabla 11 -->
...
@if ($cert->segundaNomina=='S')
        ...
        <img src="selloOficialSF.png" class="margenSuperiorImagenSN" width="85" height="85" >
