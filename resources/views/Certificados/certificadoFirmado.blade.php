...
<img src="spa.png" width="150" height="40">
    ...
    <hr>
    <!-- tabla 1 -->
    <label class="letraE">Identificación Empresa Verificada</label>
    <table>
        <thead>
            <tr>
    ...
    <!-- --tabla 2 -->
    <label class="letraE">Identificación del Proyecto</label>
    <table>
            <thead>
                <tr>
        ...
        <!-- tabla 3 -->
        <label class="letraE">Identificación Empresa Mandante</label>
        <table>
            <thead>
                <tr>
        ...
        <!-- tabla 4 -->
        <label class="letraE">Identificación Empresa Contratista</label>
         <!-- tabla 5 -->
    ...
    <label class="letraE">1.- Observación parte Remuneracional</label>
    <table>
        <thead>
            <tr>
    ...
    <label class="letraE">2.- Observación parte Previsional</label>
    <table>
        <thead>
            <tr>
                <th class="tit1 color-fondo"><label class="colorLetra letraT">Descripción </label> </th>
    ...
    <label class="letraE">3.- No presentación de documentos</label>
    <table>
        <thead>
            <tr>
                <th class="tit1 color-fondo"><label class="colorLetra letraT">Descripción </label> </th>
