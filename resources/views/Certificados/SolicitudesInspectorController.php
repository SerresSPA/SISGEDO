                ...
                /////////////////////////////////////////////////////////////////////////////  
                        ...
                        foreach ($empleadosAnteriores as $anterioresE){
                                ...
                                for($i=0;$i<count($this->matrizActual);$i++){
                                        ...
                                        if($array[0][$i]['RUT']==$anterioresE->rut AND $anterioresE->hojaNomina==1){
                                            $this->siExiste++;
                        ...
                        //dd($this->pivoteEmpleados);
                        // $empleadosCertificadosAterior=empleadoscertificado::where('pivote',$this->pivoteEmpleados)->get();
                        // dd($empleadosCertificadosAterior);
                        // if(!empty($empleadosCertificadosAterior)){
                        //     foreach($empleadosCertificadosAterior as $Anteriores){
                        //         //dd($Anteriores);
                        //        // dd($Anteriores->empleadoscertificado);
                   ...
                   ///////////////////////////////////////////////////////
                        ...
                        while($this->num<=3)
                        {
                            ...
                            $ultimaCertificacion=solicitudeproceso::where('estructura_id',$request->estructura_id)->where('mes',$this->mes)->where('ano',$this->anio)->where('estado','Liberada')->get();
                            if(!empty($ultimaCertificacion)){
                                $this->num=4;
