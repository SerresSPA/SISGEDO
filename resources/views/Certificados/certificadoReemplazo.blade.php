...
<div class="container-fluid" id="divUsers">
    <div class="row justify-content-center">
        ...
        @foreach($certificado as $cert)      
                <div class="card-header">Emisión del Certificado de Reemplazo Numero: CERT- {{ $cert->certificadoNombre }}
                ...
                <div class="card-body">
                    ...
                    @endif
<form action="{{ route('enviar.CertificadoReemplazoRevision') }}" method="POST">
                    <input type="hidden" name="certificadoAnterior" value="{{ $cert->certificadoNombre }}">
                    <!-- Contenido -->
        ...
        @CSRF
                    <div class="col-xs-12 col-md-12 mt-2">
                        <div class="card mt-2">
                            <div class="card-header">
                                Identificación del Número de Solicitud: <label><input type="text" name="solicitud_id" id="solicitud_id" class="form-control"  readonly="readonly" value="{{$cert->id}}"></label>
                            ...
                            <div class="card-body">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text"  class="form-control" value="" name="monto_remumeracional"></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" class="form-control" name="monto_previsional" value=""></td>
                                    </tr>
                                    <tr>
                        ...
                        <div class="card text-center">
                            ...
                            <div class="card-body">
                                <table class="table">
                                    ...
                                    <tr>
                                        <th>Mes Revisado </th>
                                        <th><input type="text"  value="@if($cert->mes==1) ENERO @elseif($cert->mes==2) FEBRERO @elseif($cert->mes==3) MARZO @elseif($cert->mes==4) ABRIL @elseif($cert->mes==5) MAYO @elseif($cert->mes==6) JUNIO @elseif($cert->mes==7) JULIO @elseif($cert->mes==8) AGOSTO @elseif($cert->mes==9) SEPTIEMBRE @elseif($cert->mes==10) OCTUBRE @elseif($cert->mes==11) NOVIEMBRE @elseif($cert->mes==12) DICIEMBRE  @endif-{{$cert->ano}}" class="form-control" class="largo"></th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
                                        <th>Dotación Mes Anterior</th>
                                        <th><input type="text"  value="" name="dotacionMesAnterior" class="form-control" class="largo"></th>
                                    </tr>
                                    <tr>
                                        <th>Contrataciones - Ingresos x Traslados</th>
                                        <th><input type="number" required name="TotalEmpleadosNuevos" value="" class="form-control" class="corto"></th>
                                    </tr>
                                    <tr>
                                        <th>Total Revisados</th>
                                        <th><input type="number" required  name="totalRevisados" value="" class="form-control" class="corto"></th>
                                    </tr>
                                    <tr>
                                        <th>Retiros - Finiquitos - Traslados</th>
                                        <th><input type="text" required  name="totalDesvinculados" value="" class="form-control" class="corto"></th>
                                    </tr>
                                    <tr>
                                        <th>Dotación Final del Mes</th>
                                        <th><input type="text" required  value="" name="dotacionFinal" class="form-control" class="corto"></th>
                                    </tr>
                    ...
                    <div class="col-xs-12 col-md-6 mt-2">
                        ...
                        <div class="card border-primary mb-3">
                            ...
                            <div class="card-body text-primary text-center">
                                ...
                                <input type="submit" class="btn btn-success  mb-3 mt-3" value="Enviar a Firma Certificado de Reemplazo">
                                <br/>
