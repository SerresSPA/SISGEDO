...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Menu Administrador Solicitudes Liberadas por fecha de Envío</div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-xs-12 col-md-6 shadow">
                                <form action="{{ route('liberadasxfecha.reporte') }}" method="post">
                                    @csrf
                                        <div class="form group mt-2 mb-2">
                                            <label for="exampleInputEmail1" class="mb-2 mt-2"><strong>Reporte Solicitudes Liberadas por Rangos de Fechas de Envío</strong></label>
                                        </div>
