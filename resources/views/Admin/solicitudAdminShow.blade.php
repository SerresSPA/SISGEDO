            ...
            <div class="card">
                ...
                @csrf
                    <div class="row">
                            ...
                            <div class="col-xs-12 col-md-2">
                                <label>Rut</label>
                                <input type="text" name="rutSub" readonly value="{{ $datos->rutSub}}" witdth="2" class="form-control">
                            </div>
                            
                            <div class="col-xs-12 col-md-10">
                                <label>Razón Social / Nombre (Apellido Paterno Apellido Materno Nombre)</label>
                                <input type="text" name="nomSub" readonly value="{{ $datos->nomSub}}" class="form-control">
                            </div>
                            <div class="col-xs-12 col-md-6">
                                <label>Dirección</label>
                                <input type="text" name="dirSub" readonly value="{{ $datos->dirSub}}" witdth="2" class="form-control">
                            </div>
                            
                            <div class="col-xs-12 col-md-4">
                                <label>Comuna</label>
                                <input type="text" name="comSub" readonly value="{{ $datos->comSub}}" class="form-control">
                            </div>
                            <div class="col-xs-12 col-md-2">
                                <label>Teléfono</label>
                                <input type="text" name="telSub" readonly value="{{ $datos->telSub}}" class="form-control">
                            </div>
                            ...
                            <div class="col-xs-12 col-md-2">
                                <label>Año</label>
                                <input type="number" name="ano" readonly min=2015 max=2025 value="{{ $datos->ano }}" class="form-control">
                            </div>
                            <div class="col-xs-12 col-md-2">
                                <label>Mes</label>
