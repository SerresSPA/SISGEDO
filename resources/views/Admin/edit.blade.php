                ...
                <div class="card-body">
                    ...
                    {!! Form::model($user, ['route'=>['users.update',$user->id], 'method'=>'PUT']) !!}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-2">
                                <input id="telefono" type="text" maxlength="30" class="form-control" name="telefono" value="{{ $user->telefono }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-2">
                                <input id="password" type="text" readonly class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password">
