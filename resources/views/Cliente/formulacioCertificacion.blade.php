                ...
                @csrf
                    <div class="row">
                            <div class="col-xs-12 col-md-12">
                                <center><label><strong><h4>FORMULARIO CERTIFICACION CUMPLIMIENTO OBLIGACIONES LABORALES Y PREVISIONALES</h4></strong></label></center> <!--ID: {{ $datos->id}} Solicitud para solicitar cumplimiento de obligaciones laborales y previsionales (ley de Subcontratación)  -->
                            </div>
                        <!-- nuevo -->
                            <div class="col-xs-12 col-md-12">
                            ...
                            <div class="col-xs-12 col-md-2">
                                <label>Rut</label>
                                <input type="text" name="rutContratista" witdth="2" class="form-control" readonly value="{{ $datos->estructura->empresa->rut }} ">
                            </div>
                            
                            <div class="col-xs-12 col-md-10">
                                <label>Razón Social / Nombre (Apellido Paterno Apellido Materno Nombre)</label>
                                <input type="text" name="nombreContratista" class="form-control" readonly value="{{ $datos->estructura->empresa->nombre }}">
                            </div>
                            <div class="col-xs-12 col-md-6">
                            ...
                            <div class="col-xs-12 col-md-2">
                                <label>Rut</label>
                                <input type="text" name="rutMandante" witdth="2" class="form-control" readonly value="{{ $datos->estructura->proyecto->empresa->rut }}">
                            </div>
                            
                            <div class="col-xs-12 col-md-10">
                                <label>Razón Social / Nombre (Apellido Paterno Apellido Materno Nombre)</label>
                                <input type="text" name="nombreMandante" class="form-control" readonly value="{{ $datos->estructura->proyecto->empresa->nombre }}">
                            </div>
                            <div class="col-xs-12 col-md-6">
                            ...
                            @if (isset($datos->estructura->contratistasubcontrato->rut))
                                @if ($datos->estructura->contratistasubcontrato->rut!=NULL)
                                    ...
                                    <div class="col-xs-12 col-md-2">
                                        <label>Rut</label>
                                        <input type="text" name="rutSub" readonly value="{{ $datos->estructura->contratistasubcontrato->rut }}" witdth="2" class="form-control">
                                    </div>
                                    
                                    <div class="col-xs-12 col-md-10">
                                        <label>Razón Social / Nombre (Apellido Paterno Apellido Materno Nombre)</label>
                                        <input type="text" name="nomSub" readonly value="{{ $datos->estructura->contratistasubcontrato->nombre }}" class="form-control">
                                    </div>
                                    <div class="col-xs-12 col-md-6">
                                        <label>Dirección</label>
                                        <input type="text" name="dirSub" witdth="2" readonly value="{{ $datos->estructura->contratistasubcontrato->direccion }}" class="form-control">
                                    </div>
                                    
                                    <div class="col-xs-12 col-md-4">
                                        <label>Comuna</label>
                                        <input type="text" name="comSub" readonly value="{{ $datos->estructura->contratistasubcontrato->comuna }}" class="form-control">
                                    </div>
                                    <div class="col-xs-12 col-md-2">
                                        <label>Teléfono</label>
                                        <input type="text" name="telSub" readonly value="{{ $datos->estructura->contratistasubcontrato->telefonos }}" class="form-control">
                                    </div>
                            ...
                            <div class="col-xs-12 col-md-9">
                                ...
                                <input type="text" name="proyecto" witdth="2" class="form-control" readonly value="{{ $datos->estructura->proyecto->proyecto }}">
                            </div>
                            ...
                            <div class="col-xs-12 col-md-2">
                                ...
                                <input type="text" name="contrato" class="form-control" readonly value="{{ $datos->estructura->contrato }}">
                            </div>
                            <div class="col-xs-12 col-md-12 mt-2 ">
