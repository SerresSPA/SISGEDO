...
<div class="container-fluid" id="divUsers">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Formulario de Declaración Jurada, <strong>(TODOS LOS CAMPOS CON (*) SON OBLIGATORIOS)</strong>
                ...
                <input type="hidden" name="noenviar" value="2">

                @csrf
                    <div class="row">
                            <div class="col-xs-12 col-md-12">
                                <center><label><strong><h4>Declaración Jurada de Solicitud para solicitar cumplimiento de obligaciones laborales y previsionales (ley de Subcontratación) </h4></strong></label></center> <!--ID: {{ $datos->id}} -->
                            </div>
                        <!-- nuevo -->
                            <div class="col-xs-12 col-md-12">
                            ...
                            <div class="col-xs-12 col-md-12">
                                ...
                                <center><strong><h4>
                                Haga click en el cuadro de arriba para aceptar las condiciones y Declarar que no ha Prestado servicios para el periodo a Indicar. Sin esto no podrá usar envíar el formulario
                                </h4></strong></center>
                            </div>
                            ...
                            <!-- <div class="col-xs-12 col-md-3">
                                ...
                                <input type="hidden" min=1 name="totalvigentes" value="0"  class="form-control" >
                            <!-- </div> -->
                            <div class="col-xs-12 col-md-6">
                            ...
                            <div class="col-xs-12 col-md-12 mt-2 ">
                                <label><strong><h6>5.- Antecedentes del Mes a Declarar bajo Juramento que no Presto Servicios y no debe Certificar</h6></strong></label>
                            </div>
                            <div class="col-xs-12 col-md-2">
                                <label>Año (*)</label>
                            ...
                            <!-- <div class="col-xs-12 col-md-2">
                                ...
                                <input type="hidden" min=0 name="contratados" readonly  value="0" class="form-control"  placeholder="">
                            <!-- </div> -->
                            <!-- <div class="col-xs-12 col-md-3">
                            ...
                            <div class="col-xs-12 col-md-6 mt-3">
                                <center><input type="submit" value="Enviar Declaración Jurada" class="btn btn-danger"></center>
                            </div>
                            <!-- <div class="col-xs-12 col-md-6 mt-3">
                                <center><label>
