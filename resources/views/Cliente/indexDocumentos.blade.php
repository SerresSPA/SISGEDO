    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
                                            ...
                                            <div class="col-xs-12 col-md-3 mt-2">
                                                            ...
                                                            <div class="card-body text-primary">
                                                                ...
                                                                <select name="empresa_id" id="empresa_id" class="form-control" required>
                                                                    ...
                                                                    @foreach($empresas as $empresa)
                                                                        <option value="{{ $empresa->estructura->proyecto->empresa->id }}">{{ $empresa->estructura->proyecto->empresa->rut}}, {{$empresa->estructura->proyecto->empresa->nombre}}</option>
                                                                    @endforeach
                                                                </select>
                                                                </div>
                                                        </div>
                                                    ...
                                                    <div class="col-xs-12 col-md-3 mt-2">
                                                        <div class="card border-success mb-3">
                                                            ...
                                                            <div class="card-body text-success">
                                                                <button class="btn btn-primary" id="busquedaDocumentosXcadena">Buscar Documentación.</button>                            
            ...
            <!-- fin de busqueda por cadena -->
                    ...
                    <form action="{{route('comprimirArchivosClientes.zipper')}}" method="POST">
