...
<div class="container-fluid" id="divUsers">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">FORMULARIO UNICO DE AUDITORIA DOCUMENTAL
                ...
                @csrf
                    <div class="row">
                            <div class="col-xs-12 col-md-12">
                                <center><label><strong><h4>FORMULARIO UNICO DE AUDITORIA DOCUMENTAL <!-- ID: {{ $datos->id}} --></h4></strong></label></center>
                            </div>
                            <div class="col-xs-12 col-md-12">
                        ...
                        <tr>
                            <td scope="row">
                                <select name="tipo_documento" class="form-control" required>
                                    ...
                                    <option value="Control Documental Trabajadores">Control Documental Trabajadores</option>
                                    <option value="Control Documental Empresa">Control Documental Empresa</option>
                                    <option value="Control documental vehiculos">Control documental vehiculos</option>
                                    <option value="Poliza COVID 19">Póliza COVID 19</option>
                                    <!-- <option value="Otros">Otros</option> -->
                                </select>
                            </td>
                            <!-- <td><input type="checkbox" name="otro" value="1"></td> -->
                            <td><textarea  cols="60" name="otraopcion"></textarea></td>
                ...
                <!-- fin seccion nueva  -->
                            ...
                            <div class="col-xs-12 col-md-2">
                                <label>Rut</label>
                                <input type="text" witdth="2" name="rutMandante" class="form-control" readonly value="{{ $datos->estructura->proyecto->empresa->rut }}">
                            </div>
                            ...
                            <div class="col-xs-12 col-md-12 mt-2 ">
                                <label><strong><h6>3.- Individualización de la Obra, Empresa o Faena por la cual solicita el Certificado</h6></strong></label>
                            </div>
                            ...
                            <div class="col-xs-12 col-md-12 mt-2 ">
                                <label><strong><h6>4.- Individualización del Contacto ante SERRESVERIFICADORA SPA</h6></strong></label>
                            </div>
                            <div class="col-xs-12 col-md-9">
                                <label>Nombre</label>
                            ...
                            <div class="col-xs-12 col-md-12 mt-2 ">
                                <label><strong><h6>5.- Archivos para Adjuntar</h6></strong></label>
                            </div>
                            <!-- <div class="col-xs-12 col-md-12">
                            ...
                            <div class="col-xs-12 col-md-12">
                                <label>Set de Documentos ( Solo Archivo ZIP) * Dato Obligatorio</label>
                                <input type="file" name="set" witdth="2" class="form-control" required>
                            </div>
