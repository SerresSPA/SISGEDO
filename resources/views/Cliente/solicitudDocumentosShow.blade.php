...
<div class="container-fluid" id="divUsers">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Solicitudes rechazadas de Documentación
                ...
                <input type="hidden" name="solicitud_id" value="{{ $datos->id}}">
                    ...
                    <div class="row">
                            <div class="col-xs-12 col-md-12">
                                <center><label><strong><h4>Formulario Único de Auditoria Documental ID: {{ $datos->id}}</h4></strong></label></center>
                            </div>

                             <!-- seccion nueva formulario -->
                             <div class="col-xs-12 col-md-3">
                                Número de Certificado
                                    <input type="number" name="numerocertificado" readonly value="{{$datos->numerocertificado}}" class="form-control mb-1">
                                </div>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <select name="rectCert" readonly class="form-control">
                                    @if ($datos->rectcert==1)
                        ...
                        <tr>
                            ...
                            <td>
                            <select name="contdocutrab" readonly class="form-control">
                        ...
                        <tr>
                            ...
                            <td>
                            <select name="contdocuempr" readonly class="form-control">
                        ...
                        <tr>
                            ...
                            <td>
                            <select name="evalfina" readonly class="form-control">
                                    @if ($datos->evalfina==1)
                        ...
                        <tr>
                            ...
                            <td>
                            <select name="otro" readonly class="form-control">
                                    @if ($datos->otro==1)
                            ...
                            <td><input type="text" readonly name="otraopcion" class="form-control" value="{{$datos->otroobser}}"></td>
                ...
                <!-- fin seccion nueva  -->
                            ...
                            <div class="col-xs-12 col-md-3">
                                ...
                                <input type="number" min=0 name="totalvigentes" readonly  value="{{ $datos->totalvigentes }}" class="form-control">
                            </div>
                            <div class="col-xs-12 col-md-6">
                            ...
                            <div class="col-xs-12 col-md-2">
                                <label>Año</label>
                                <input type="number" name="ano" readonly min=2015 max=2025 value="{{ $datos->ano }}" class="form-control" readonly>
                            </div>
                            <div class="col-xs-12 col-md-2">
                                <label>Mes</label>
                                <input type="text" readonly value="@if($datos->mes==1)Enero @elseif($datos->mes==2)Febrero @elseif($datos->mes==3)Marzo @elseif($datos->mes==4)Abril @elseif($datos->mes==5)Mayo @elseif($datos->mes==6)Junio @elseif($datos->mes==7)Julio @elseif($datos->mes==8)Agosto @elseif($datos->mes==9)Septiembre @elseif($datos->mes==10)Octubre @elseif($datos->mes==11)Noviembre @elseif($datos->mes==12)Diciembre @endif" class="form-control" readonly>
                            ...
                            <div class="col-xs-12 col-md-2">
                                ...
                                <input type="number" min=0 name="contratados" readonly  value="{{ $datos->contratados }}" class="form-control" >
                            </div>
                            <div class="col-xs-12 col-md-2">
                                <label>N° Desvinculados</label>
                                <input type="number" min=0 name="desvinculados"  readonly value="{{ $datos->desvinculados }}" class="form-control" >
                            </div>
                            <div class="col-xs-12 col-md-2">
                                <label>N° de Otras Causales</label>
                                <input type="number" min=0 name="otrascausas" readonly value="{{ $datos->otrascausas }}" class="form-control" >
                            </div>
                            <div class="col-xs-12 col-md-2">
                            ...
                            <div class="col-xs-12 col-md-12 mt-2 ">
                                <label><strong><h6>7.- Archivos de la Solicitud</h6></strong></label>
                            </div>
